...
{
	/* fstream file;
	file.open("/public/home/yels/Tmscore/b.txt",ios::out|ios::app); */
    if (outfmt_opt<=0)
    {
       ...
       /*  printf("\n -------- rotation matrix to rotate Chain-1 to Chain-2 ------\n");
		...
		/* printf("%17.10f %14.10f %14.10f %14.10f%17.10f %14.10f %14.10f %14.10f%17.10f %14.10f %14.10f %14.10f\n",t[0],u[0][0],u[0][1],u[0][2],t[1],u[1][0],u[1][1],u[1][2],t[2],u[2][0],u[2][1],u[2][2]); */
		if (a_opt==1)
            printf("%5.4f\n", TM3);
        if (u_opt)
            printf("%5.4f \n", TM4);
