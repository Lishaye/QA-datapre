...
if __name__ == '__main__':
    # file1=open("/public/home/yels/project/CASP/CASP10/casp10_label/global_s11.csv",'a',newline='')
    # csv_write = csv.writer(file1,dialect='excel')
    # N=['name','GDT_TS']
    # csv_write.writerow(N)
    file=open("/public/home/yels/project/CASP/CASP10/casp10_label/dists_s1bk.csv",'a',newline='')
    csv_write = csv.writer(file,dialect='excel')
    N=['index','seq']
    csv_write.writerow(N)
    f1=file1_name(r'/public/home/yels/project/CASP/CASP10/casp10_target/')
    for f in f1:
    #/public/home/yels/project/CASP/CASP10/casp10_target/T0648-D1.pdb
        temp=f.split('/')[-1]
        target=temp.split('-')[0]
        print(target)
        f2='/public/home/yels/project/CASP/CASP10/casp10_stage1/'+target
        df2=get_pdb("1",f)
        ff2=file2_name(f2)
        for ff in ff2:
            name=ff.split('/')[-1]
