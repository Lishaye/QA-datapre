...
def file_name(file_dir):  
  ...
  for root, dirs, files in os.walk(file_dir): 
    for file in files: 
        ...
        #L.append(file)
  return L
data1=pd.read_csv("/public/home/yels/project/CASP/CASP13/casp13_label/global_s2.csv")
...
for i in range(0,length):
    ...
    for i in range(a,b-1):
        ...
        if len(target)>=7:
           ...
           name1=model[6:]
        path='/public/home/yels/project/CASP/CASP13/casp13_stage2/'+target
        M1=path+'/'+name1
        #print(M1)
        for j in range (i+1,b):
            ...
            if len(target)>=7:
               ...
               name2=model1[6:]
            path1='/public/home/yels/project/CASP/CASP13/casp13_stage2/'+target
            M2=path1+'/'+name2
            #print(M2)
            args='./a.out'+' '+M1+' '+M2
            #print(args)
